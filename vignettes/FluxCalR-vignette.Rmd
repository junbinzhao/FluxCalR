...
Then, use the function `SelCue()` to manually select the end point of each measurement. After executing the function, a interactive graph will pop up for the user to click on the corresponding points. The END points of the measurements are recommended here because they are usually associated with sudden drops or increases in concentrations when removing the chamber, making them easier to be identified then the starting points. 
...
```
![](C:/Research Material/R code & function/R Packages/FluxCalR/inst/images/timecue.png)
...
```
![](C:/Research Material/R code & function/R Packages/FluxCalR/inst/images/output.png)
